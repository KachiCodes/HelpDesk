...
String url = "jdbc:mysql://localhost/helpdesk";
    ...
    public void getReady()
    {
        try
        {
            ...
            ResultSet rs = con.createStatement().executeQuery("SELECT * FROM software");
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        ...
        if(prob=="Select Problem")
        {
            ...
            try
            {
                ...
                Class.forName("com.mysql.jdbc.Driver");
                Connection con = DriverManager.getConnection(url, user, pass);
                ResultSet rs = con.createStatement().executeQuery("SELECT * FROM software WHERE Problem='"+prob+"'");
                while(rs.next())
                {
